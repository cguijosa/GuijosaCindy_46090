...
int main(int argc, char** argv) {
    ...
    //Output the future value of out savings
    cout<<fixed<<showpoint<<setprecision(2);
    cout<<"Present value= $"<<pv<<endl;
    cout<<"Interest Rate=  "<<i*100<<"%"<<endl;
    cout<<"Years to save=  "<<nCmpd<<endl;        
    ...
    float fnCmpd=nCmpd;
    cout<<"Same savings 5 but with n as a float.\n";
    cout<<"Savings 5= "<<save5(pv,i,fnCmpd)<<endl;
    cout<<"Bank Savings 6= "<<save6(pv,i,nCmpd)<<endl;
    cout<<"Peoples Bank Savings 7= "<<save7(pv,i,nCmpd)<<endl;
    cout<<"More Peoples Bank Savings 8= "<<save8(pv,i,nCmpd)<<endl;
