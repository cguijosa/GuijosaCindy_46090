...
int main(int argc, char** argv) {
    ...
    check=s1+s2+s3+s4+s5+s6+s7+s8+s9+s10+s11+s12;
    //Display the results
    ...
    cout<<"Out of "<<nGames<<" 10 was thrown "<<setw(4)<<s10<<" times "<<endl;
    cout<<"Out of "<<nGames<<" 11 was thrown "<<setw(4)<<s11<<" times "<<endl;
    cout<<"Out of "<<nGames<<" 12 was thrown "<<setw(4)<<s12<<" times "<<endl;
