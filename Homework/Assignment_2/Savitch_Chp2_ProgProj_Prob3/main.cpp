 ...
 * Purpose: Homework; calculate new annual salary with pay increase of any month length
...
int main(int argc, char** argv) {
    ...
    do
    {
        ...
        unsigned short months, noMonth;//The duration of pay increase
        float monPay, incPerM, newMPay, newMTot, noPInc, retPay;

        //Prompt and Input
        cout<<"What was your previous annual salary?\n";
        cin>>annuPay;
        cout<<"How many months is the pay increase in effect?\n";
        cin>>months;
        ...
        noMonth=12-months;//number of months increase isn't in effect
        noPInc=monPay*noMonth;//Total for duration pay increase isn't applied
